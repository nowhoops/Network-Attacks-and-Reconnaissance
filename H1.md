...
| **TCP/IP Layer** | **Protocol Example(s)** | **Description / Function** |
|-------------------|--------------------------|-----------------------------|
| **Application** | TLSv1.2, DNS | Provides network services directly to users and applications — includes encryption (TLS) and name resolution (DNS). |
| **Transport** | TCP | Ensures reliable communication between hosts, with sequencing, flow control, and acknowledgments (ACKs). |
| **Internet** | ICMPv6 | Handles logical addressing, routing, and diagnostics for IPv6 networks. |
| **Network Access (Link)** | Ethernet, Wi-Fi, ARP | Defines physical and data link functions for moving frames across local networks. |
