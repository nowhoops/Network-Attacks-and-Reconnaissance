...
# X)
- Pyramid of Pain (Bianco, 2013): The model illustrates how  different types of threat indicators (IOCs) and how much “pain”  adn disruption they cause the attacker
- Diamond Model (Caltagirone e2013):  Model shows that every intrusion event consists of four interconnected components Adversary , Infrastructure, Capability and Victim and the relationships between them. Helps to analyze the attack
...
- If you find one manually. You can find others comming from the same ip.
...
```
# G) Agent
- Making my User-Agent look like a normal browser with extra parameters.
...
- CTRL + o
- CTRL + x
- when you will do a new scan you will see it like this.
- 
<img width="947" height="263" alt="image" src="https://github.com/user-attachments/assets/45f6ce9d-3a0b-43e4-99f7-9709e6825ba2" />

# J) Super agent
- Whith this you can find all scritps wiht nmap
```bash
grep -Ri "nmap" /usr/share/nmap/scripts /usr/share/nmap/nselib

```
- If you don’t want to be detected, you can change it like in the previous example (I).
- For example, if you see a line like: "Nmap ssl-heartbleed" you can change if you want
